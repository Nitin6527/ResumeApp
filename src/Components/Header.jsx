...
export default function Header() {
  ...
  const steps = ['Basics', 'Education', 'Job', 'Summary', 'Skills', 'Extra', 'Done'];
    ...
    return (
      <>
        {!props.active && !props.completed && (
          <ColorlibStepIconRoot ownerState={{ active }} icon={props.icon} className={className}>
            <span style={{ color: 'black' }}>{icons[String(props.icon)].iconNo}</span>
        ...
        {props.completed && (
          <ColorlibStepIconRoot ownerState={{ completed }} icon={props.icon} className={className}>
            {/* {icons[String(props.icon.iconLogo)]} */}
            <span style={{ color: 'white' }}>{icons[String(props.icon)].iconNo}</span>
          </ColorlibStepIconRoot>
        )}
      </>
    );
