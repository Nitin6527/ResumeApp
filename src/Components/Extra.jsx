          ...
          <>
              ...
              <div className="stars" style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <Col xs={6} style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <form onSubmit={updateL}>
                    ...
                    <FaPlusSquare color="green" size={40} onClick={updateL} />
                  </form>
                </Col>
              </div>
            </Row>
            {[...languages].map((language, i) => (
              <Row style={{ margin: '4px' }}>
                ...
                >
                  <Col xs={6}>{language.language}</Col>
                  <Col xs={6}>
                    {[...Array(parseInt(language.rating))].map((_, k) => (
                      <FaStar key={k} size={50} color={'#ffc107'} />
                    ))}
                    {5 - parseInt(language.rating) > 0 &&
                      [...Array(parseInt(5 - language.rating))].map((_, k) => (
                        <FaStar key={k} size={50} color={'#e4e5e9'} />
                      ))}
                    <FaTrash
                      color="red"
                      size={40}
                ...
                <Col xs={5}>
                  <Form.Group className="mb-3" controlId="formcertificate">
                    <Form.Control
                      ...
                      value={date}
                      onChange={updatedate}
                      placeholder="29-05-2001"
                      maxLength={10}
                    />
                  </Form.Group>
                </Col>
                <Col>
                  <FaPlusSquare color="green" size={40} onClick={updateC} />
                </Col>
              </div>
            </Row>
          </>
