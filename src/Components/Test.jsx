        ...
        <section className="left-section">
          <div className="left-content">
            ...
            <div className="skills-section">
              ...
              {[...skills].map((skill) => (
                <h3 style={{ color: 'white' }} className="skill-title">
                  {skill.skill}
                </h3>
              ))}
            </div>
        ...
        <section className="right-section">
          <div className="right-main-content">
            <section className="about sect">
              ...
              <p className="para">
                {[...Summary].map((skill) => (
                  <span style={{ color: 'black' }} className="skill-title">
                    {skill}&nbsp;
                  </span>
                ))}
              </p>
                ...
                <div className="right-tl-content">
                  <div className="tl-content">
                    ...
                    <p className="para">
                      ...
                      vitae voluptatem deleniti, laboriosam odio nobis quae fugit facilis quo.
                    </p>
                  </div>
                </div>
              </div>
