    ...
    <div className="Test left">
      <Container style={{ display: 'flex', flexDirection: 'row' }}>
        ...
        <Col xs={4} style={{ display: 'flex', flexDirection: 'column', border: '1px solid black' }}>
          <Row
            ...
            style={{
              flex: '1',
              width: '100%',
              borderBottom: '1px solid #002333',
              paddingLeft: '10px',
            }}
          >
            <div className="image">{/* <img src="../images/beluga.jpg" alt="profile" / > */}</div>
          ...
          <Row className="skills" style={{ flex: 1 }}></Row>
          <Row className="references" style={{ flex: 1 }}></Row>
        </Col>
        {/* right section */}
        <Col xs={8} style={{ border: '1px solid red' }}>
          ...
          {/* Main Content */}
          <Row style={{ border: '3px solid blue', margin: '3px' }}>{/* Awards */}</Row>
        </Col>
      </Container>
    </div>
  );
